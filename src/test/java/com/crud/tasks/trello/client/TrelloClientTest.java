...
public class TrelloClientTest {
    ...
    public void init(){
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("testowy");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/testowy/boards?key=test&token=test&fields=name,id&lists=all");
